...
/// 自动域名加密脚本
/// 
/// 自动检测当前环境（Debug/Release）并加密对应的域名配置到 assets/encrypted_domains.dat
/// Debug模式: 使用development域名
/// Release模式: 使用production域名
...
class AutoDomainEncryptor {
  ...
  Future<void> processDomainsFile() async {
    try {
      ...
      print('');
      print('💡 应用运行时将根据Debug/Release模式自动选择对应环境的域名');
      print('   - Debug模式 → development环境域名');
      print('   - Release模式 → production环境域名');
...
Future<void> main(List<String> args) async {
  ...
  final encryptor = AutoDomainEncryptor();
