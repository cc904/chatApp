...
class UINotificationHelper {
  ...
  static void showError(String message) {
    UINotificationService.instance.showError(message);
  }

  /// 在异步操作中安全地显示成功消息
  static void showSuccess(String message) {
    UINotificationService.instance.showSuccess(message);
  }

  /// 在异步操作中安全地显示警告消息
  static void showWarning(String message) {
    UINotificationService.instance.showWarning(message);
  }

  /// 在异步操作中安全地显示处理中消息
  static void showProcessing(String message) {
    UINotificationService.instance.showProcessing(message);
  }
